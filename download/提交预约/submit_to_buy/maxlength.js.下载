...
function setformfieldsize($fields, optsize, optoutputdiv){
	...
	$fields.each(function(i){
		var $field=$(this)
		$field.data('maxsize', optsize || parseInt($field.attr('datamaxsize'))) //max character limit
		var statusdivid=optoutputdiv || $field.attr('dataoutput') //id of DIV to output status
...
jQuery(document).ready(function($){ //fire on DOM ready
	var $targetfields=$("input[datamaxsize], textarea[datamaxsize]") //get INPUTs and TEXTAREAs on page with "data-maxsize" attr defined
